...
\epigraph{\begin{french}Je connaissais Manon: pourquoi m'affliger tant d'un malheur que j'avais dû prévoir.\end{french}}{\workname{Manon Lescaut}}



\lettrine{T}{he} gale had blown itself out into a wonderful fresh day, with clear spaces of sky, and a high wind rolling boulders of cumulus down the blue slopes of air.
...
The ravening pencils of the reporters tore along the paper. The lean young man who worked for the \workname{Daily Trumpet} scented a scandal in high life and licked his lips, never knowing what a much bigger one had escaped him by a bare minute or so.
...
\begin{french}
	...
	\begin{mail}{Riddlesdale Lodge,\\Stapley,\\\acronym{NE} Yorks.\\le 13 Octobre, 192—}{Simone---}
