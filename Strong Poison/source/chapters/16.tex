...
I feel sure you will be anxious to hear, at the \textit{earliest possible} moment \textit{how} things are \textit{going}, and though I have only been here \textit{one} day, I really think I have \textit{not} done so \textit{badly}, all things considered!

My train got in quite late on Monday night, after a \textit{most dreary} journey, with a \textit{lugubrious} wait at \textit{Preston}, though thanks to your kindness in insisting that I should travel \textit{First-class}, I was not really at all tired! Nobody can realise what a \textit{great} difference these extra comforts make, especially when one is \textit{getting on} in years, and after the \textit{uncomfortable} travelling which I had to endure in my days of poverty, I feel that I am living in almost \textit{sinful} luxury! The carriage was \textit{well} heated—indeed, \textit{too much} so and I should have liked the window down, but that there was a \textit{very fat} business man, \textit{muffled} up to the eyes in \textit{coats} and \textit{woolly waistcoats} who \textit{strongly} objected to fresh air! Men are such \textsc{hot-house plants} now-a-days, are they not, quite unlike my dear father, who would never permit a \textit{fire} in the house \textit{before} November the 1st, or \textit{after} March 31st even though the thermometer was at \textit{freezing-point!}

I had \textit{no} difficulty in getting a comfortable room at the Station Hotel, \textit{late} as it was. In the old days, an \textit{unmarried} woman arriving \textit{alone} at \textit{midnight} with a \textit{suitcase} would hardly have been considered \textit{respectable}—what a wonderful difference one finds today! I am \textit{grateful} to have lived to see such changes, because whatever old-fashioned people may say about the greater \textit{decorum} and \textit{modesty} of women in Queen Victoria's time, those who can remember the old conditions know how \textit{difficult} and \textit{humiliating} they were!

Yesterday morning, of course, my \textit{first} object was to find a \textit{suitable boarding-house}, in accordance with your instructions, and I was \textit{fortunate} enough to hit upon this house at the \textit{second} attempt. It is very well run and \textit{refined}, and there are three \textit{elderly ladies} who are \textit{permanent} boarders here, and are \textit{well up} in all the \textsc{gossip} of the town, so that nothing could be more \textit{advantageous} for our purpose!!

As soon as I had engaged my room, I went out for a little \textit{voyage of discovery}. I found a very helpful \textit{policeman} in the High Street, and asked him where to find Mrs~Wrayburn's house. He knew it quite well, and told me to take the \textit{omnibus} and it would be a penny ride to the <Fisherman's Arms> and then about 5 minutes' walk. So I followed his directions, and the 'bus took me right into the country to a \textit{cross-roads} with the <Fisherman's Arms> at the corner. The conductor was most polite and helpful and showed me the way, so I had \textit{no difficulty} in finding the house.

It is a \textit{beautiful old place}, standing in its own grounds—quite a \textit{big} house built in the \textit{eighteenth century}, with an \textit{Italian} porch and a lovely green lawn with a cedar-tree and formal flower-beds, and in summer must be really a \textit{garden of Eden}. I looked at it from the road for a little time—I did not think this would be at all \textit{peculiar} behaviour, if anybody saw me, because \textit{anybody} might be interested in such a fine old place. Most of the \textit{blinds} were down, as though the greater part of the house were \textit{uninhabited}, and I could not see any \textit{gardener} or anybody about—I suppose there is not very much to be done in the garden this time of the year. One of the \textit{chimneys} was smoking, however, so there were \textit{some} signs of life about the place.

I took a little \textit{walk} down the road and then turned back and passed the house again, and this time I saw a servant just passing round the corner of the house, but of course she was \textit{too far off} for me to speak to. So I took the omnibus back again and had lunch at Hillside View, so as to make acquaintance with my fellow-boarders.

Naturally I did not want to seem \textit{too eager} all at once, so I said nothing about Mrs~Wrayburn's house \textit{at first}, but just talked \textit{generally} about Windle. I had some difficulty in parrying the \textit{questions} of the good ladies, who \textit{wondered} very much \textit{why} a stranger had come to Windle at this time of year, but without telling many actual \textit{untruths} I think I left them with the \textit{impression} that I had come into a little fortune~(!) and was visiting the Lake District to find a suitable spot in which to settle next \textit{summer!} I talked about \textit{sketching}—as girls we were \textit{all} brought up to dabble a little in water-colours, so that I was able to display quite sufficient \textit{technical knowledge to satisfy them!}

That gave me quite a \textit{good} opportunity to ask about the \textit{house!!} Such a \textit{beautiful} old place, I said, and did anybody live there? (Of \textit{course} I did not blurt this out \textit{all at once}—I waited till they had told me of the many \textit{quaint spots} in the district that would interest an artist!) Mrs~Pegler, a very \textit{stout}, \textsc{pussy} old lady, with a \textsc{long tongue}~(!) was able to tell me \textit{all} about it. My dear Lord~Peter, what I do \textit{not} know now about the \textit{abandoned wickedness} of Mrs~Wrayburn's early life is really \textsc{not worth knowing!!} But what was \textit{more to the point} is that she told me the \textit{name of} Mrs~Wrayburn's \textit{nurse-companion}. She is a \textsc{Miss~Booth}, a retired nurse, about \textit{sixty} years old, and she lives \textit{all alone} in the house with Mrs~Wrayburn, except for the \textit{servants}, and a \textit{housekeeper}. When I heard that Mrs~Wrayburn was so \textit{old}, and \textit{paralysed} and \textit{frail}, I said was it not very \textit{dangerous} that Miss~Booth should be the only attendant, but Mrs~Pegler said the housekeeper was a \textit{most trustworthy} woman who had been with Mrs~Wrayburn for many years, and was \textit{quite} capable of looking after her any time when Miss~Booth was out. So it appears that Miss~Booth does go out sometimes! Nobody in this house seems to \textit{know} her \textit{personally}, but they say she is often to be seen in the town in \textit{nurse's uniform}. I managed to extract quite a good description of her, so if I should happen to meet her, I daresay I shall be \textit{smart} enough to \textit{recognise} her!

That is really \textit{all} I have been able to discover in \textit{one} day. I hope you will not be \textit{too} disappointed, but I was obliged to listen to a terrible amount of \textit{local history} of one kind and another, and of course I could not \textsc{force} the conversation round to Mrs~Wrayburn in any suspicious way.

I will let you know as \textit{soon} as I get the \textit{least bit} more information.
...
<How vexatious!> said Miss~Climpson, as the vehicle disappeared. <I must have just missed her somewhere. Or perhaps she was having tea in a private house. Well, I'm afraid this is a blank day. And I do feel so \textit{full} of tea!>
...
<Well now, so I could,> cried Miss~Climpson. <How clever of you to think of it. Of course, yes, that would be the best way. You must think me very foolish, but the idea never occurred to me. I'm not a very practical person, I'm afraid, but I do so admire the people who are. I should never do to take up \textit{your} profession, should I? Any little emergency leaves me \textit{quite} bewildered.>

The nurse smiled again.

<It is largely a question of training,> she said. <And of \textit{self}-training, too, of course. All these little weaknesses can be cured by placing the mind under a Higher Control—don't you believe that?>
...
The reply was lost on Miss~Climpson, for she had suddenly seen the title of the book on the table, and the Devil, or a Ministering Angel (she was not quite sure which) was, so to speak, handing her a fullblown temptation on a silver salver. The book was published by the Spiritualist Press and was called <\textit{Can the Dead Speak?}>
...
<It does seem \textit{most} wonderful, doesn't it?< said Miss~Climpson, aloud. >But isn't it a wee bit \textit{dangerous}? I've been told I'm sensitive myself, but I have never dared to \textit{try}. Is it \textit{wise} to open one's mind to these supernatural influences?>
...
<Well,> said Miss~Climpson, slowly, <I'm willing just to try. But I can't say I really \textit{believe} in it, you know.>
...
I am sure you have been \textit{wondering} what has \textit{happened} to me. But \textit{at last} I have \textsc{news!} I have \textsc{stormed the citadel!!!} I am going to the \textit{house tonight} and you may expect \textsc{great things!!!}
