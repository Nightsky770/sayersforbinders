...
<I am not allowing myself to contemplate any other possibility. But \emph{when} that happens, public interest will be liable to die down very quickly. I am, of course, securing the most advantageous contracts I possibly can at the moment, to cover the next three or four books, but I can only really control the advances. The actual receipts will depend on the sales, and that is where I foresee a slump. I am, however, doing well with serial rights, which are important from the point of view of immediate returns.>
