...
<Very likely, Miss~Etheredge,> replied Mrs~Pegler, drawing her stout figure to its most impressive uprightness, <but that is not the point. I do not say that a spiritualist \emph{may} not live a good life, but I \emph{do} say that the majority of them are most unsatisfactory people, and far from truthful.>

<I have happened to meet with a number of so-called mediums in the course of my life,> agreed Miss~Tweall, acidly, <and all of them, without \emph{any} exception, were people I would not have trusted any further than I could see them—if as far.>

<That is very true of a great many of them,> said Miss~Climpson, <and I am sure \emph{nobody} could have better opportunities of judging than \emph{myself}. But I think and hope that some of them are at least \emph{sincere} if \emph{mistaken} in their claims. What do \emph{you} think, Mrs~Liffey?> she added, turning to the proprietress of the establishment.
...
<Without altogether subscribing to your wholesale condemnation,> said Miss~Climpson, <I must agree that psychical research can be \emph{very dangerous indeed} in the \emph{wrong hands}, and from what Miss~Booth tells me, I do doubt very \emph{much} whether Mrs~Craig is a suitable guide for the inexperienced. Indeed, I quite felt it my \emph{duty} to put Miss~Booth on her guard, and that is what I am endeavouring to do. But, as you know, one has to do that kind of thing \emph{very} tactfully—otherwise one may merely, so to speak, put the person's back up. The first step is to gain her \emph{confidence}, and then, little by little, one may be able to induce a more wholesome frame of mind.>

<That's \emph{so} true,< said Miss~Etheredge, eagerly, her pale blue eyes lighting with something that was almost animation. >I very nearly fell under the influence of a dreadful, fraudulent person myself, till my dear friend showed me a better way.>
