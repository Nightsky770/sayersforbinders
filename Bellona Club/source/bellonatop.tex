...
\vfill
Title page decoration is from an illustration entitled \foreignquote{french}{Le Jardin d'Hiver du Ritz}, which appeared in the January 1924 issue of the French fashion magazine \foreignquote{french}{Art - Goût - Beauté: Feuillets de l'élégance féminine}. The original is held by the Rijksmuseum in Amsterdam.
\vfill
Typeset in \LaTeX{}.
\end{center}
\thispagestyle{empty}
